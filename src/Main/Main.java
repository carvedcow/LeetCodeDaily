...
public class Main {
	 ...
	 * 
	 * Input: "The quick brown fox jumped over the lazy dog" Output:
	 ...
	 * not use the same element twice. Given nums = [2, 7, 11, 15], target = 9,
	 * 
	...
	// Task 3
	/*
	 * Reverse an Integer int x = 123 -> x = 321
	 */
